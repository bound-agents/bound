	...
	it("detects tasks running longer than 15 minutes", () => {
		...
		insertRow(
			...
			"threads",
			{
				...
				title: "t",
				created_at: oldClaim,
				last_message_at: oldClaim,
				modified_at: oldClaim,
				deleted: 0,
			},
			siteId,
		);
		...
		insertRow(
			...
			"tasks",
			{
				...
				payload: "run something",
				thread_id: threadId,
				created_at: oldClaim,
				last_run_at: oldClaim,
				modified_at: oldClaim,
				deleted: 0,
				claimed_by: siteId,
				claimed_at: oldClaim,
		...
		insertRow(
			...
			"tasks",
			{
				...
				payload: "recent task",
				thread_id: threadId,
				created_at: recentClaim,
				last_run_at: recentClaim,
				modified_at: recentClaim,
				deleted: 0,
				claimed_by: siteId,
				claimed_at: recentClaim,
				lease_id: randomUUID(),
				run_count: 0,
				consecutive_failures: 0,
				heartbeat_at: null,
	...
	it("detects user messages with no assistant reply", () => {
		...
		insertRow(
			...
			"threads",
			{
				...
				last_message_at: userMsgTime,
				modified_at: userMsgTime,
				deleted: 0,
			},
			siteId,
		);
	...
	it("does not flag mid-turn threads as unanswered", () => {
		...
		insertRow(
			...
			"threads",
			{
				...
				title: "coding",
				created_at: userMsgTime,
				last_message_at: toolCallTime,
				modified_at: toolCallTime,
				deleted: 0,
			},
			siteId,
		);
		...
		insertRow(
			...
			"messages",
			{
				...
				thread_id: threadId,
				role: "tool_call",
				content: "boundless_read",
				model_id: null,
				tool_name: "boundless_read",
				created_at: toolCallTime,
				modified_at: null,
				host_origin: siteId,
				deleted: 0,
				exit_code: null,
