 ...
 */
export function writeEmbeddedLowboxModule(stagedExe: string | null): void {
	...
	let hash = "none";
	if (stagedExe) {
		const stagedBin = join(STAGE_DIR, "bound-lowbox.exe.lowboxbin");
	...
	writeFileSync(join(STAGE_DIR, "embedded.ts"), lines.join("\n"));
}
